...
{{--    </p>--}}
    <div class="page_image_container" style="height: 100vh">
        <div class="page_image" style="background-image: url(../images/home_photo_2.jpg)"></div>
    </div>
    <br>
    ...
    <div class="spoiler_block" data-spoiler>
        <div class="spoiler_title">
            Каталог №11. Прайс-лист на услуги по озеленению
        </div>
        <div class="spoiler_content">
            <table class="table">
                <tbody>
